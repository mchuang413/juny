...
last_news_time = news_collection.find_one(sort=[("time_published", -1)])["time_published"]
if news_item["time_published"] > last_news_time:
...
try:
    ...
    logging.info("Pinged MongoDB successfully.")
