...
const Page = () => {
  ...
  const questions = [
    {
      question: "What does liquidity refer to in the context of stock exchanges?",
      options: [
        "a. The ability to borrow money to buy stocks",
        "b. The ease with which an asset can be bought or sold without affecting its price",
        "c. The number of stocks available for trade",
        "d. The fees charged by brokers for trading"
      ],
      answer: "b. The ease with which an asset can be bought or sold without affecting its price"
    },
    {
      question: "The New York Stock Exchange (NYSE) operates without a physical trading floor.",
      options: ["True", "False"],
      answer: "False"
    },
    {
      question: "Stock exchanges help determine the prices of securities through supply and demand.",
      options: ["True", "False"],
      answer: "True"
    },
    {
      question: "In the U.S., the Securities and Exchange Commission (SEC) regulates stock exchanges to ensure fair trading practices.",
      options: ["True", "False"],
      answer: "True"
    }
  ];
