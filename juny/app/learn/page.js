  ...
  const units = [
    {
      ...
      description:
        "Learn the basics of investing, including its definition and purpose. Discover the history of investing and why people invest their money. This lesson sets the foundation for understanding how investments can grow your wealth over time. 📈📚",
    ...
    },
    {
      ...
      description:
        "Learn the principles of asset allocation and diversification strategies. Understand how to build a balanced and diversified investment portfolio tailored to your financial goals. 📊💼",
      requiredLevel: 51,
    },
    {
      title: "UNIT 19: Risk Management",
      description:
        "Explore techniques for identifying and mitigating investment risks, including the use of stop-loss orders and hedging strategies. Understand how to protect your portfolio from significant losses. 📉🛡️",
      requiredLevel: 54,
    },
    {
      title: "UNIT 20: Performance Measurement",
      description:
        "Discover metrics for measuring portfolio performance and the importance of benchmarking. Learn how to evaluate your portfolio's success and make necessary adjustments. 📈📉",
      requiredLevel: 57,
    },
    {
      title: "UNIT 21: Rebalancing",
      description:
        "Understand why and when to rebalance your portfolio. Learn techniques for rebalancing to maintain your desired asset allocation and risk level. 🔄📊",
      requiredLevel: 60,
    },
    {
      title: "UNIT 22: Investment Strategies",
      description:
        "Explore different investment strategies such as value investing, growth investing, and income investing. Learn how to apply these strategies to achieve your financial goals. 📈📚",
      requiredLevel: 63,
    },
    {
      title: "UNIT 23: Options Trading",
      description:
        "Understand the basics of options trading, including calls and puts. Learn about various option strategies such as covered calls and protective puts. 📈📉",
      requiredLevel: 66,
    },
    {
      title: "UNIT 24: Futures and Commodities",
      description:
        "Explore futures trading and commodity markets. Learn how to use futures for hedging and speculative purposes. 📊🌾",
      requiredLevel: 69,
    },
    {
      title: "UNIT 25: Forex Trading",
      description:
        "Discover the basics of the foreign exchange market, including currency pairs and trading strategies. Understand how to trade forex and manage currency risk. 🌍💱",
      requiredLevel: 72,
    },
    {
      title: "UNIT 26: Short Selling",
      description:
        "Learn the mechanics of short selling, including its risks and benefits. Understand how to profit from declining stock prices. 📉💡",
      requiredLevel: 75,
    },
    {
      title: "UNIT 27: Leverage and Margin Trading",
      description:
        "Understand leverage and margin trading, including margin requirements and associated risks. Learn how to use leverage to amplify returns and the potential pitfalls. 📈💸",
      requiredLevel: 78,
    },
    {
      title: "UNIT 28: Psychology of Investing",
      description:
        "Explore common biases such as overconfidence and herd behavior. Understand how emotional influences can affect investment decisions and strategies to mitigate these biases. 🧠📊",
      requiredLevel: 81,
    },
    {
      title: "UNIT 29: Market Sentiment",
      description:
        "Learn how to measure market sentiment and its impact on financial markets. Understand how investor sentiment drives market trends and how to use it in your investment strategy. 📈📉",
      requiredLevel: 84,
    },
    {
      title: "UNIT 30: Behavioral Strategies",
      description:
        "Discover techniques to mitigate biases and maintain a long-term perspective. Learn strategies to improve decision-making and enhance investment performance. 🧠📈",
      requiredLevel: 87,
    },
    {
      title: "UNIT 31: Socially Responsible Investing (SRI)",
      description:
        "Understand the definition and importance of SRI. Learn about SRI strategies and how to incorporate them into your investment portfolio. 🌱📈",
      requiredLevel: 90,
    },
    {
      title: "UNIT 32: Environmental, Social, and Governance (ESG) Investing",
      description:
        "Explore ESG criteria and the impact of ESG investing. Learn how to evaluate investments based on their environmental, social, and governance practices. 🌍💼",
      requiredLevel: 93,
    },
    {
      title: "UNIT 33: Ethical Dilemmas in Investing",
      description:
        "Discover how to balance profit and principles. Explore ethical case studies to understand the challenges and opportunities of ethical investing. 🛡️📊",
      requiredLevel: 96,
    },
    {
      title: "UNIT 34: Types of Real Estate Investments",
      description:
        "Learn about different types of real estate investments, including residential and commercial properties, as well as Real Estate Investment Trusts (REITs). 🏠🏢",
      requiredLevel: 99,
    },
    {
      title: "UNIT 35: Real Estate Valuation",
      description:
        "Discover methods of real estate valuation and market analysis. Understand how to determine the value of real estate investments. 🏘️📊",
      requiredLevel: 102,
    },
    {
      title: "UNIT 36: Financing Real Estate",
      description:
        "Understand the basics of mortgage financing and leveraging property. Learn how to finance your real estate investments effectively. 💰🏡",
      requiredLevel: 105,
    },
    {
      title: "UNIT 37: Property Management",
      description:
        "Explore the pros and cons of renting vs. selling properties. Learn how to manage rental properties and maximize returns. 🏠🔑",
      requiredLevel: 108,
    },
    {
      title: "UNIT 38: Tax Basics",
      description:
        "Understand capital gains tax and dividend tax. Learn how taxes impact your investment returns and strategies to manage them. 💸📊",
      requiredLevel: 111,
    },
    {
      title: "UNIT 39: Tax-Advantaged Accounts",
      description:
        "Discover the benefits of tax-advantaged accounts such as retirement accounts and education savings accounts. Learn how to use these accounts to maximize tax efficiency. 📈💼",
      requiredLevel: 114,
    },
    {
      title: "UNIT 40: Tax Strategies",
      description:
        "Learn about tax-loss harvesting and tax deferral strategies. Understand how to optimize your investment portfolio for tax savings. 💡📊",
      requiredLevel: 117,
    },
    {
      title: "UNIT 41: International Tax Considerations",
      description:
        "Explore the challenges of investing in foreign markets, including double taxation. Learn strategies to manage international tax implications. 🌍📈",
      requiredLevel: 120,
    },
    {
      title: "UNIT 42: Introduction to Algorithmic Trading",
      description:
        "Understand the basics of algorithmic trading and different types of algorithms used in the market. 📊🤖",
      requiredLevel: 123,
    },
    {
      title: "UNIT 43: Developing Trading Algorithms",
      description:
        "Learn coding basics (Python, R) and strategies for backtesting trading algorithms. Discover how to develop and test your own trading strategies. 💻📉",
      requiredLevel: 126,
    },
    {
      title: "UNIT 44: High-Frequency Trading",
      description:
        "Explore the mechanics, risks, and challenges of high-frequency trading. Understand how high-frequency traders operate in the market. ⚡📈",
      requiredLevel: 129,
    },
    {
      title: "UNIT 45: Machine Learning in Trading",
      description:
        "Discover the applications of machine learning in trading strategies. Learn how machine learning algorithms can enhance trading performance. 🧠📊",
      requiredLevel: 132,
    },
    {
      title: "UNIT 46: Cryptocurrency Investing",
      description:
        "Understand the basics of cryptocurrencies and blockchain technology. Learn about the risks and opportunities in cryptocurrency investing. 🪙📈",
      requiredLevel: 135,
    },
    {
      title: "UNIT 47: Robo-Advisors",
      description:
        "Explore what robo-advisors are, their benefits, and drawbacks. Understand how robo-advisors are changing the landscape of investing. 🤖💼",
      requiredLevel: 138,
    },
    {
      title: "UNIT 48: Sustainable Investing",
      description:
        "Learn about green investments and how to measure their impact. Discover the importance of sustainable investing for the future. 🌍💚",
      requiredLevel: 141,
    },
    {
      title: "UNIT 49: Fintech Innovations",
      description:
        "Explore new financial technologies and their impact on traditional investing. Understand how fintech innovations are disrupting the financial industry. 📈💼",
      requiredLevel: 144,
    },
  ];
      ...
      {units.map((unit, unitIndex) => (
        <div key={unitIndex} className="relative w-full mb-16 z-10 pt-4">
          <div className="relative w-full flex justify-center">
            <a
              href={
                userLevel >= unit.requiredLevel
                  ? `/learn/units/unit${unitIndex + 1}`
                  : "#"
              }
              className={`block w-3/4 p-10 ${
                userLevel >= unit.requiredLevel ? "bg-blue-400" : "bg-gray-400"
              } text-white border ${
                userLevel >= unit.requiredLevel
                  ? "border-blue-400"
                  : "border-gray-400"
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p
                    className={`font-normal mb-4 ${
                      userLevel < unit.requiredLevel ? "blur" : ""
                    }`}
                  >
                    {unit.description}
                  </p>
                ...
                <div
                  ...
                  active:border-b-[0px] transition-all duration-150 ${
                    userLevel >= unit.requiredLevel
                      ? "[box-shadow:0_10px_0_0_#1b6ff8,0_15px_0_0_#1b70f841] border-b-[1px] border-blue-400"
                      : "[box-shadow:0_10px_0_0_#888888,0_15px_0_0_#888888] border-b-[1px] border-gray-400"
                  }`}
                >
                  <span className="flex flex-col justify-center items-center h-full text-white font-bold text-lg">
                    {userLevel < unit.requiredLevel ? (
                      <img src="/lock.png" alt="locked" className="h-8 w-8" />
                    ) : (
                      "Learn"
                    )}
                  </span>
          ...
          <div className="relative w-full h-[400px] mt-8">
            {(unitIndex % 2 === 0 ? buttonPositionsLeft : buttonPositionsRight).map(
              (pos, starIndex) => {
                const quizLevel = units[unitIndex].requiredLevel + starIndex;
                const buttonColor =
                  userLevel < quizLevel
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-8 rounded-lg shadow-lg flex flex-col items-center">
            ...
            <p className="text-gray-700 mb-4">
              You need to pass all previous quizzes to unlock this content!
            </p>
            <button
